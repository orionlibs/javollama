...
public final class LLMOptionsBuilder
{
    public LLMOptions build()
    {
        ...
        options.add(new LLMProp("streamChat", ConfigurationService.getBooleanProp("orion-llm4j.stream.chat")));
        options.add(new LLMProp("echoChat", ConfigurationService.getBooleanProp("orion-llm4j.echo.chat")));
