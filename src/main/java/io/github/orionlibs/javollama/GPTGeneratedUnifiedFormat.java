...
final class GPTGeneratedUnifiedFormat
{
    ...
    private void loadModelImpl(FileChannel fileChannel) throws IOException
    {
        ...
        {
            GPTGeneratedUnifiedFormat.GGUFTensorInfo ti = readTensorInfo(fileChannel);
        ...
        for(Map.Entry<String, GPTGeneratedUnifiedFormat.GGUFTensorInfo> entry : tensorInfos.entrySet())
        {
            GPTGeneratedUnifiedFormat.GGUFTensorInfo ti = entry.getValue();
    ...
    private GPTGeneratedUnifiedFormat.GGUFTensorInfo readTensorInfo(FileChannel fileChannel) throws IOException
    {
        ...
        return new GPTGeneratedUnifiedFormat.GGUFTensorInfo(name, dimensions, ggmlType, offset);
    }
